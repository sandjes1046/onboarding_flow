                            ...
                            if(key === "address")
                            {
                                return(
                                    <div className='flex flex-col justify-center gap-4'  key={key}>
                                        <TextField required type='street' label={'Street'} value={fieldAnswers['street'] || ''} onChange={(e) => {setFieldAnswers({...fieldAnswers,['street']:e.target.value})}}/>
                                        <TextField required label={'City'}  value={fieldAnswers['city'] || ''} onChange={(e) => {setFieldAnswers({...fieldAnswers,['city']:e.target.value})}}/>
                                        <TextField required label={'State'}  value={fieldAnswers['state'] || ''} onChange={(e) => {setFieldAnswers({...fieldAnswers,['state']:e.target.value})}}/>
                                        <TextField required
